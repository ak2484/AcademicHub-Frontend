...
<<<<<<< HEAD
      ...
      <Route path='layout' element={<Layout />}>
        ...
        <Route
          ...
          element={
            <CourseForm
              departments={["CSE", "Mechanical", "Electrical"]}
        ...
        <Route
          ...
          element={
            <LabForm
              courses={["CS 101", "Physics 201"]}
              departments={["CSE", "Mechanical"]}
              teachers={["Mr. Smith", "Ms. Johnson"]}
              labAssistants={["John Doe", "Jane Roe"]}
            />
          }
        />
        <Route
        ...
        <Route
          path='experiments'
          element={<ExperimentForm labs={["Physics Lab", "Chemistry Lab"]} />}
        />
        <Route
          path='exams'
          element={
