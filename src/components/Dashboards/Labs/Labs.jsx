...
export default function LabForm({ courses, departments, teachers, labAssistants }) {
  ...
  return (
    ...
    >
      {currentStep === 0 && (
        <div>
          <h2 className="font-bold mb-4 text-palatinate-blue text-sm">Basic Lab Information</h2>
          <div className='mb-4'>
          ...
          <div className='mb-4'>
            <label className='block text-gray-700 text-sm font-semibold mb-2' htmlFor='labCode'>
              Lab Code
            </label>
            <input
              type='text'
      ...
      {currentStep === 1 && (
        <div>
          <h2 className="text-sm font-bold mb-4 text-palatinate-blue">Select Course and Staff</h2>
          <div className='mb-4'>
          ...
          <div className='mb-4'>
            <label className='block text-gray-700 text-sm font-semibold mb-2' htmlFor='course'>
              Course
            </label>
            <select
              id='course'
      ...
      {currentStep === 2 && (
        <div>
          <h2 className="text-sm font-bold mb-4 text-palatinate-blue">Assign Staff</h2>
          ...
          <div className='mb-4'>
            <label className='block text-gray-700 text-sm font-semibold mb-2' htmlFor='teacherInCharge'>
              Teacher In Charge
            </label>
            <select
              id='teacherInCharge'
          ...
          <div className='mb-4'>
            <label className='block text-gray-700 text-sm font-semibold mb-2' htmlFor='labAssistant'>
              Lab Assistant
            </label>
            <select
              id='labAssistant'
