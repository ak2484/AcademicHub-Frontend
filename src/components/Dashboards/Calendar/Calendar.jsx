...
const StudentCalendar = () => {
  ...
  return (
    <div className='m-4 flex justify-center items-center bg-gray-100 w-full text-dark-imperial-blue'>
      <div className='bg-lavender-web shadow-smoky-black shadow-lg rounded-lg p-6 w-full md:w-3/4 lg:w-1/2'>
        ...
        <div className='w-full h-auto '>
          <Calendar
            ...
            tileClassName={({ date, view }) => {
              ...
              const isImportant = importantDates.some((d) =>
                isSameDay(d.date, date)
              );
              return isImportant ? "bg-blue-100" : "";
            }}
            className='mx-auto border rounded-lg shadow bg-lavender-web'
          />
        </div>
