...
>
  ...
  <div className="mb-4">
    ...
    <input
      ...
      className="w-full px-4 py-2 border border-gray-300 rounded-md text-gray-700 bg-gray-50 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors duration-200"
