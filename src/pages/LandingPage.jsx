      ...
      <div className='container px-4 mx-auto relative text-sm'>
        <div className='flex justify-between items-center'>
          ...
          <div className='hidden lg:flex justify-center space-x-4 items-center font-sans'>
            <button onClick={() => navigate('/login')} className='py-2 px-4 border rounded-lg'>
              Sign In
            </button>
            <button
        ...
        {mobileDrawOpen && (
          <div className='fixed right-0 z-20 bg-neutral-900 w-full p-12 flex flex-col justify-center items-center lg:hidden text-smoky-black'>
            <ul className='flex flex-col space-y-4'>
              <li>
                <a href='' className='text-white-smoke'>Home</a>
              </li>
              <li>
                <a href='' className='text-white-smoke'>Products</a>
              </li>
              <li>
                <a href='' className='text-white-smoke'>About Us</a>
              </li>
              <li>
                <a href='' className='text-white-smoke'>Contact Us</a>
              </li>
            </ul>
            <div className='flex space-x-6 mt-4'>
              <button onClick={() => navigate('/login')} className='py-2 px-3 rounded-lg font-sans'>
                Sign In
              </button>
              <button onClick={() => navigate('/enroll')} className='py-2 px-3 rounded-lg bg-white-smoke font-sans'>
                Enroll
              </button>
            </div>
          </div>
...
// Combine exports
export { Footer, HeroSection, Navbar };
